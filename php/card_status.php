...
<html lang="en">
  ...
  <body>
    <div class="container-fluid">
      <div class="align-items-center">
        ...
        >
          ...
          <h1 class="text-center fw-bold mb-2">
            <span class="multicolortext">Student Card Status</span>
          </h1>
          <hr />
          <form action="../php/card_status_active.php" method="POST">
          <div class="mb-3">
          <label for="id_no" class="form-label">ID_NO</label>
          <input type="text" class="form-control" name="user_id" id="id_no">    
        </div>
        <div class="form-group mb-3">
          <label class="form-label" class="mb-0">Card_status</label>
          <select class="form-select" name="card_status" aria-label="Default select example" >
      ...
      <button type="submit" name="submit" class="btn btn-primary">Status_update</button>
      </div>
